...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - TEKKEN 8 Bob Wiki",
    description: "Read the Terms of Service for TEKKEN 8 Bob Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our TEKKEN 8 Bob DLC resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - TEKKEN 8 Bob Wiki",
      description: "Terms and conditions for using TEKKEN 8 Bob Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using TEKKEN 8 Bob Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using TEKKEN 8 Bob Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and TEKKEN 8 Bob Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              TEKKEN 8 Bob Wiki is an unofficial, community-driven fan website that provides information, guides, and
              resources related to the Bob DLC character in the fighting game "TEKKEN 8" (available on PlayStation 5,
              Xbox Series X|S, and PC via Steam). Our services include, but are not limited to:
            </p>
            <ul>
              <li>Release date and early access information for Bob</li>
              <li>Move lists and command references</li>
              <li>Spinner Ball stance and Heat system guides</li>
              <li>Combo routes and wall combos</li>
              <li>Punishers and frame data references</li>
              <li>Matchup notes and counter-strategies</li>
            </ul>
            <p>
              <strong>Important:</strong> TEKKEN 8 Bob Wiki is NOT affiliated with, endorsed by, or associated with
              Bandai Namco Entertainment Inc. or the official developers of TEKKEN 8. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by TEKKEN 8 Bob Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Bandai Namco Entertainment Inc. and/or the developers of TEKKEN 8. We use such
            ...
            <ul>
              <li><strong>Accuracy:</strong> We strive to provide accurate information, but we do not guarantee that all content is current, complete, or error-free. Game updates and patches may render information outdated.</li>
              ...
              <li><strong>DLC Release Changes:</strong> Release dates, early access windows, and DLC content may change without notice. We are not responsible for official schedule changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, TEKKEN 8 BOB WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including the official TEKKEN site, Bandai Namco
              Entertainment, Steam, Discord, Reddit, social media platforms, and other external resources. These links
            ...
            <p>
              ...
              you and TEKKEN 8 Bob Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@tekken8bob.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@tekken8bob.wiki</a>
            </p>
            <p>
