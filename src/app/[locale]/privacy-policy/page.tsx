...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - TEKKEN 8 Bob Wiki',
    description: 'TEKKEN 8 Bob Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our TEKKEN 8 Bob DLC resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              TEKKEN 8 Bob Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including the official TEKKEN site, Bandai Namco
              Entertainment, Steam, Discord, Reddit, and social media platforms. We are not responsible for the privacy
              practices or content of these third-party sites. We encourage you to review their privacy policies before
            ...
            <h2>11. Disclaimer</h2>
            <p>
              TEKKEN 8 Bob Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Bandai Namco Entertainment Inc. or the official developers of TEKKEN 8. All game content, trademarks,
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@tekken8bob.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@tekken8bob.wiki</a>
            </p>
            <p>
